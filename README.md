...
<details>
  ...
  **⚠ Antes de começar, seu docker-compose precisa estar na versão 1.29 ou superior. Veja [na documentação](https://docs.docker.com/compose/install/) como instalá-lo. No primeiro artigo, você pode substituir onde está com `1.26.0` por `1.29.2`.**
